...
PROMPT = """
Extrae todos los productos de esta carta de restaurante con su familia/Sección, precio y formato. No incluyas ningún comentario ni explicación. Fíjate bien en los precios de cada uno de ellos. Énvíame sólo el JSON con este formato:
